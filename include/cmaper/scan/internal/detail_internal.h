...
cmaper_err_t
cmaper_scan_detail_run_command(const cmaper_scan_detail_request_t *request,
                               const cmaper_scan_detail_command_t *command,
                               const char *phase_label, int heartbeat_seconds,
                               const char *xml_output_path,
                               char **out_stderr_data, size_t *out_stderr_size);
