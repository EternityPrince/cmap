...
const cmaper_nmap_xml_address_t *
cmaper_nmap_host_mac_address(const cmaper_nmap_xml_host_t *host) {
  size_t i;
...
cmaper_err_t
cmaper_nmap_host_open_tcp_ports_sorted(const cmaper_nmap_xml_host_t *host,
                                       int **out_ports, size_t *out_count) {
  int *ports = NULL;
  size_t count = 0;
  size_t capacity = 0;
  size_t i;
