...
void cmaper_cli_diag_set(cmaper_cli_diagnostic_t *diag, const char *argument,
                         const char *message) {
...
void cmaper_cli_diag_setf(cmaper_cli_diagnostic_t *diag, const char *argument,
                          const char *fmt, ...) {
  va_list args;
...
void cmaper_cli_diag_vsetf(cmaper_cli_diagnostic_t *diag, const char *argument,
